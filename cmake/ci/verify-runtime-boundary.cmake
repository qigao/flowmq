...
if(NOT IS_DIRECTORY "${FLOWMQ_RUNTIME_ROOT}")
  message(FATAL_ERROR "FlowMQ runtime source directory is missing: ${FLOWMQ_RUNTIME_ROOT}")
endif()
...
set(FLOWMQ_RUNTIME_FORBIDDEN_PATTERNS
    "cflow/"
    "cflow_"
    "FunctionMeta[ 	
]*\\("
...
foreach(_flowmq_runtime_file IN LISTS FLOWMQ_RUNTIME_BOUNDARY_FILES)
  ...
  foreach(_flowmq_forbidden IN LISTS FLOWMQ_RUNTIME_FORBIDDEN_PATTERNS)
    string(REGEX MATCH "${_flowmq_forbidden}"
           _flowmq_runtime_match "${_flowmq_runtime_text}")
    if(_flowmq_runtime_match)
      ...
      message(FATAL_ERROR
        ...
        "forbidden execution/reflection token '${_flowmq_runtime_match}'. "
