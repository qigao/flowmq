...
#define FLOWMQ_TLS_CERTIFICATE_SHA256_TEXT_SIZE 71u
#define FLOWMQ_TLS_CERTIFICATE_SHA256_CAPACITY 72u
#define FLOWMQ_TLS_IDENTITY_MAP_DEFAULT_MAX_TOTAL_STRING_BYTES \
  (64u * (FLOWMQ_TLS_CERTIFICATE_SHA256_CAPACITY + \
          FLOWMQ_PROTOCOL_MAX_IDENTITY_SIZE + 1u))
