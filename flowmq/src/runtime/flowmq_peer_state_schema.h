...
#define FLOWMQ_PEER_LIFECYCLE_BIT(state_value) \
  ((uint8_t)(UINT8_C(1) << (state_value)))
 ...
 */
#define FLOWMQ_PEER_LIFECYCLE_SCHEMA(M)                                      \
  Schema(M,                                                                  \
         (FLOWMQ_PEER_LIFECYCLE_FREE,                                        \
          FLOWMQ_PEER_LIFECYCLE_BIT(FLOWMQ_PEER_LIFECYCLE_ALLOCATED)),       \
         (FLOWMQ_PEER_LIFECYCLE_ALLOCATED,                                   \
          FLOWMQ_PEER_LIFECYCLE_BIT(FLOWMQ_PEER_LIFECYCLE_FREE) |            \
              FLOWMQ_PEER_LIFECYCLE_BIT(FLOWMQ_PEER_LIFECYCLE_CONNECTED) |   \
              FLOWMQ_PEER_LIFECYCLE_BIT(FLOWMQ_PEER_LIFECYCLE_RETIRED)),     \
         (FLOWMQ_PEER_LIFECYCLE_CONNECTED,                                   \
          FLOWMQ_PEER_LIFECYCLE_BIT(FLOWMQ_PEER_LIFECYCLE_CLOSE_RETRY) |     \
              FLOWMQ_PEER_LIFECYCLE_BIT(FLOWMQ_PEER_LIFECYCLE_CLOSING) |     \
              FLOWMQ_PEER_LIFECYCLE_BIT(FLOWMQ_PEER_LIFECYCLE_RETIRED)),     \
 ...
 */
#define FLOWMQ_PEER_HANDSHAKE_SCHEMA(M)                                      \
  Schema(M,                                                                  \
         (FLOWMQ_PEER_HANDSHAKE_HELLO_TX, 0u),                               \
         (FLOWMQ_PEER_HANDSHAKE_HELLO_RX, 0u),                               \
